...
public class Admin extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        docIdentityref = FirebaseDatabase.getInstance().getReference("Admin");
    ...
    public void uploadData() {
        ...
        final StorageReference mountainImagesRef = myRef2.child("Admin/" + randomKey + "." + extension);
        ...
        if (Name.isEmpty()) {
            Toast.makeText(Admin.this, "Name is required!", Toast.LENGTH_SHORT).show();
        } else if (ID.isEmpty()) {
            Toast.makeText(Admin.this, "ID is required!", Toast.LENGTH_SHORT).show();
        } else if (Phone.isEmpty()) {
            Toast.makeText(Admin.this, "Phone is required!", Toast.LENGTH_SHORT).show();
        } else if (Email.isEmpty()) {
            Toast.makeText(Admin.this, "Email is required!", Toast.LENGTH_SHORT).show();
        } else if (Department.isEmpty()) {
            Toast.makeText(Admin.this, "Department is required!", Toast.LENGTH_SHORT).show();
        } else if (Degree.isEmpty()) {
            Toast.makeText(Admin.this, "Degree number is required!", Toast.LENGTH_SHORT).show();
        } else if (Password.isEmpty()) {
            Toast.makeText(Admin.this, "Password is required!", Toast.LENGTH_SHORT).show();
        } else {
            final ProgressDialog pd = new ProgressDialog(Admin.this);
